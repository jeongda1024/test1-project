				...
				<div class="sub_tit_wrap">
					<div class="sub_tit_inner">
						...
						<ul class="smap">
							...
							<li><img class="arrow" src="//image.istarbucks.co.kr/common/img/common/icon_arrow.png" alt="하위메뉴"></li>
							<li><a href="/menu/drink_list.do" class="cate"></a></li>
							<li><img class="arrow" src="//image.istarbucks.co.kr/common/img/common/icon_arrow.png" alt="하위메뉴"></li>
					...
					<div class="product_view_wrap1">
						...
						<div class="product_view_detail">
                            ...
                            <div class="m_view_slide">
                                ...
                                <p id="prevBtn"><a href="javascript:void(0)" role="button">이전 버튼</a><!-- 접근성_20171123 role 추가 --></p>
                                <p id="nextBtn"><a href="javascript:void(0)" role="button">다음 버튼</a><!-- 접근성_20171123 role 추가 --></p>
                            </div>
